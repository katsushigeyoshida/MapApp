...
### ■履歴  
2025/03/12 フォトリストでサブディレクトリまで写真を検索に変更、ソート機能追加  
2025/03/07 ヤマレコリストに山リスト(日本百名山など)データの取得・表示を追加  
2025/03/01 詳細表示ダイヤログでURLをダブルクリックするとURLを開く  
2025/02/28 Fitデータの登録にGPX変換を追加  
2024/12/19 バグ修正  
